export const EN_TRANSLATION = {
  translation: {
    "Sort your lists easily !": "Sort your lists easily !",
    Sort: "Sort",
    ...
    "Unable to copy to clipboard":
      "Unable to copy the list to the clipboard, try with a newer browser",
    "Go Back": "Go Back",
    ...
    "Save list failed": "Could not save list. Try again.",
    "something went wrong": "Oops something went wrong...",
    loading: "Loading...",
    "sign in to save": "Sign in to save lists",
    "no list saved": "No list saved.",
